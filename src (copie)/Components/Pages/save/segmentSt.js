        ...
        <MDBRow>
          <MDBCol >
            ...
            <Text style={tailwind(' p-2 text-Indigo-700 items-center')}>D1 : </Text>
                    ...
                    <div  ><View style={styles.row}>
                    <div>  <input  onChange={handle22Change}type="radio" value="Ascendant" name="gender13" /> <Text style={tailwind(' p-2 text-gray-700')}>Ascendant</Text></div>
                    <div>  <input  onChange={handle22Change}type="radio" value="horizontal" name="gender13" /> <Text style={tailwind(' p-2 text-gray-700')}>horizontal</Text></div>
                    <div>  <input  onChange={handle22Change}type="radio" value="descendant" name="gender13" /> <Text style={tailwind(' p-2 text-gray-700')}>descendant</Text></div>
                    </View>
                </div></div>}
